...
const services = [
    ...
    { name: 'Disney+', id: '337', logo: 'https://image.tmdb.org/t/p/w500/uzKjVDmQ1PzlmyRaaVpbyDq4GAQ.png', href:'/discover/337' },
    { name: 'Amazon Prime Video', id: '9', logo: 'https://image.tmdb.org/t/p/w500/ifhbNuuVnlwYy5oXA5VIb2YR8AZ.png', href:'/discover/9' },
    { name: 'Hulu', id: '453', logo: 'https://image.tmdb.org/t/p/w500/zZN5XlitQGk3I5d2E4Iu0a4392.png', href:'/discover/453' },
    { name: 'Max', id: '1899', logo: 'https://image.tmdb.org/t/p/w500/Aau221n5XF2r7s4S2U3iP9qfOa.png', href:'/discover/1899' },
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-4">
        {services.map((service) => (
          <Link key={service.id} href={service.href} className="group">
            <Card className="relative flex items-center justify-center p-6 bg-card rounded-lg transition-all duration-300 ease-in-out aspect-video md:hover:scale-105 md:hover:shadow-[0_0_25px_5px] md:hover:shadow-white/20 md:hover:border-white">
              <div
